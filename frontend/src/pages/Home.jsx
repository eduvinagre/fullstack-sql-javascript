...
const baseURL =
     "https://outstanding-puce-woolens.cyclic.app/api/v1/shopper/validation";
     ...
     async function handleSubmit() {
          try {
               ...
               if (error.response && error.response.data) {
                    ...
                    if (
                         responseData.errors &&
                         responseData.errors.product_code &&
                         responseData.errors.product_code.msg
                    ) {
                         console.log(
                              error.response.data.errors.product_code.msg
                         );
                         setError(error.response.data.errors.product_code.msg);
                    } else if (
                         responseData.errors &&
                         responseData.errors.new_price &&
                         responseData.errors.new_price.msg
                    ) {
